...
export const Register = (props) => {
    ...
    return (
        ...
        <form className="register-form" onSubmit={handleSubmit}>
            ...
            <input value={location} name=";location" onChange={(e) => setLocation(e.target.value)} id="location" placeholder="city name" />
            <label htmlFor="name">Age</label>
            <input value={age} name="age" onChange={(e) => setAge(e.target.value)} id="age" placeholder="age" />
